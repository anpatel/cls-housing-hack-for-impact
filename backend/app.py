...
def query_documents():
    ...
    topic_response = 'to help me, as an attorney, get a quick glance at what the case is about, please tell me what the primary issue is in this case, such as "mold" or "water leakage" or "broken heater." it should be no longer than a phrase or two.: ' + \
        data['question']
